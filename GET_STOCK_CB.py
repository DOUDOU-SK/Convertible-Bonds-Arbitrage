...
##############PART 6: Get Factors at target trading date

def GET_Factors(trade_date_str, df, limit_ups , Win ,GAP = '1min', FixTime = True): 
    ...
    result_df = dfx.groupby('Ticker').apply(lambda group: Factors(group, Win ,GAP, FixTime)).reset_index()
